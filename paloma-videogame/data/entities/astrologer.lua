...
function entity:create_card()
  ...
  local prop_card = {x = x, y = y, layer = layer + 1,
    direction = 0, width = 16, height = 16, sprite = "sprites/magic_deck", name = "card"}
...
function entity:start_spell()
  ...
  map:get_entity("magic_ball"):get_sprite():set_animation("magic_deck")
--  map:get_entity("magic_ball"):get_sprite():set_animation("light")AUTÉNTICA LÍNEA SUPERIOR
...
function galeno:on_interaction()
    game:start_dialog("castillo_1.galeno.first_time")
end
